...
void DSoundInstance::SetCurrentPosition(int dwNewPosition)
{
	if (mSoundBuffer != NULL)
		mSoundBuffer->SetCurrentPosition(dwNewPosition);	
}
...
bool DSoundInstance::Play()
{
	return Play(isLooping, false);
}
