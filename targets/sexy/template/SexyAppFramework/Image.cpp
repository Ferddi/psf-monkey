...
void Image::DrawPoints(const TriVertex *theVertexList, int theNumVertices, int theDrawMode)
{
}
...
void Image::SetClipRect(int theX, int theY, int theWidth, int theHeight)
{
}
