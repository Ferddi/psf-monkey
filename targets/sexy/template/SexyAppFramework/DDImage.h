...
public:	
	...
	virtual void			NormalDrawPoints(const TriVertex theVertexList[], int theNumVertices);
	virtual void			AdditiveDrawPoints(const TriVertex theVertexList[], int theNumVertices);
...
public:
	...
	virtual void			DrawPoints(const TriVertex theVertexList[], int theNumVertices, int theDrawMode);
